        ...
        <div class="row g-0">
            <div class="col-md-6">
                <div class="card-body">
                    ...
                    <form action="/StripeAPI/checkout.php" method="post">
                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <td>'.$_SESSION['cycle'].'</td>
                            </tr>
                            <tr>
                            <th scope="row">Plan Price</th>
                            <td>&#8377;'.$_SESSION['price'].'/'.$_SESSION['cycle'].'</td>
                            </tr>
                        </tbody>
                    </table>
